...
function FormDialogConfirm(props) {
  ...
  return (
    <div>
      ...
      >
        <DialogTitle>{'Bạn đang thực hiện hành động xóa vĩnh viễn'}</DialogTitle>
        <DialogContent>
          <DialogContentText id="alert-dialog-slide-description">Bạn có muốn xóa vĩnh viễn không ?</DialogContentText>
        </DialogContent>
        <DialogActions>
